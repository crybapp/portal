...
import { chromium, ffmpeg, ffmpegaudio, openbox, pulseaudio, xdotool, xvfb } from './utils'
...
export default class VirtualBrowser {
	...
	public videoBitrate: string
	public videoFps: string
	...
	public handleControllerEvent = (data: any, type: string) => {
	...
	private setupChromium = () => chromium(
		this.env,
		this.width,
		this.height,
		this.startupUrl
	).on('close', this.setupChromium)
